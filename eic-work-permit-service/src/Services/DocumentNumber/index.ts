...
export const DocumentNumberController = async (payload: IRabbitMQServerMessage) => {
  switch (payload.route) {
    ...
    case DocumentNumberRoutes.POST_DOCUMENT_NUMBER: {
      return await DocumentNumberService.postDocumentNumber(payload.data)
    }
...
class DocumentNumberService {
  ...
  static async postDocumentNumber(prop: IPostDocumentNumber) {
    return await (await DocumentNumberResolver.Mutation.postDocumentNumber({}, prop, {})).data
  }
