...
const {
  ...
  Mutation: { edit, login, logout, post, removeOne, removeMany, removeAll, postAccount }
} = AccountActions
...
const AccountResolver = {
  ...
  Mutation: {
    ...
    async [postAccount](_: any, data: any, context: any) {
      return await AccountService.postAccount(data, {})
    },
