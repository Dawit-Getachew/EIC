...
import WorkPermitCancellationTable from './WorkPermitCancellationTable';
import { subDays } from 'date-fns';
import { FC } from "react";

interface Props {
  work_permit_cancellations: any[]
}

const RecentOrders: FC<Props>= ({ work_permit_cancellations }) => {
  ...
  return (
    <Card>
      <WorkPermitCancellationTable cryptoOrders={work_permit_cancellations.map(item => ({
        ...cryptoOrders[0],
        ...item
      })) } />
    </Card>
