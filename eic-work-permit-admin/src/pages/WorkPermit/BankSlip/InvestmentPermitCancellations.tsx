...
import InvestmentPermitsTable from './InvestmentPermitsCancellationTable';
import { subDays } from 'date-fns';
import { FC } from "react";

interface Props {
  investment_permit_cancellations: any[]
}

const RecentOrders: FC<Props>= ({ investment_permit_cancellations }) => {
  ...
  return (
    <Card>
      <InvestmentPermitsTable cryptoOrders={investment_permit_cancellations.map(item => ({
        ...cryptoOrders[0],
        ...item
      })) } />
    </Card>
