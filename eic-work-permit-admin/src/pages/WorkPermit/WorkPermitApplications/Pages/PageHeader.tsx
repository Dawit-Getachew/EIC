...
import { DownloadPermitData } from "./DownloadPermitData"
      ...
      <Box display="flex" mb={3}>
        <Tooltip arrow placement="top" title="Go back">
          <IconButton
            ...
            sx={{ p: 2, mr: 2 }}
            onClick={() => {
              navigate(routes.WORK_PERMIT.WORK_PERMIT.ROUTE, {
                replace: true,
              });
            }}
          >
          ...
          <Grid item md={9}>
            <Box>
              <Typography variant="h3" component="h3" gutterBottom>
                Work Permit for {props.name}
              </Typography>
              <Typography variant="subtitle2">
                This is a page shows every detail of {props.name} work permitdddd
                application
              </Typography>
            </Box>
          </Grid>
          <Grid item md={3} justifyContent="flex-end">
            <Tooltip arrow placement="top" title="Print Permits">
              <IconButton color="primary" sx={{ p: 2, mr: 2 }}>
                {props.data.permit_status ===
                InvestmentPermitStatus.ACCEPTED_BANK_SLIP ? (
                  <PDFDownloadLink
                    document={
                      <MainDocument
                        data={{
            ...
            <Tooltip arrow placement="top" title="Print Permit Datass">
              <IconButton>
