...
const InvestmentDetail: FC<Props> = (props) => {
  ...
  useEffect(() => {
    if (Object.keys(savedBuffer).length > 0) {
      FormActions.UpdateFormData(selectRequriedKeys([...inputs, "investment_address"], savedBuffer), dispatch)
    }
          ...
          >
            <Grid item md={4} xs={12}>
              <FormControl className="flex-c" style={{ marginTop: 25 }}>
                ...
                <TextField className="default-input" variant="outlined" {...register("investment_region", formState, dispatch)} />
              </FormControl>
            </Grid>
            <Grid item md={4} xs={12}>
              <FormControl className="flex-c" style={{ marginTop: 25 }}>
                <FormLabel id="demo-radio-buttons-group-label">City</FormLabel>
                <TextField className="default-input" variant="outlined" {...register("investment_city", formState, dispatch)} />
              </FormControl>
            </Grid>
            <Grid item md={4} xs={12}>
              <FormControl className="flex-c" style={{ marginTop: 25 }}>
                <FormLabel id="demo-radio-buttons-group-label">Sub-City</FormLabel>
                <TextField className="default-input" variant="outlined" {...register("investment_sub_city", formState, dispatch)} />
              </FormControl>
            </Grid>
          </Grid>
          <Grid
          ...
          >
            <Grid item md={4} xs={12}>
              <FormControl className="flex-c" style={{ marginTop: 25 }}>
                ...
                <TextField className="default-input" variant="outlined" {...register("investment_zone", formState, dispatch)} />
              </FormControl>
            </Grid>
            <Grid item md={4} xs={12}>
              <FormControl className="flex-c" style={{ marginTop: 25 }}>
                <FormLabel id="demo-radio-buttons-group-label">House Number</FormLabel>
                <TextField className="default-input" variant="outlined" {...register("investment_house_number", formState, dispatch)} />
              </FormControl>
            </Grid>
          </Grid>
          <Grid
          ...
          >
            <Grid item md={4} xs={12}>
              <FormControl className="flex-c" style={{ marginTop: 25 }}>
                ...
                <TextField className="default-input" variant="outlined" {...register("investment_telephone_mobile", formState, dispatch)} />
              </FormControl>
            </Grid>
            <Grid item md={4} xs={12}>
              <FormControl className="flex-c" style={{ marginTop: 25 }}>
                <FormLabel id="demo-radio-buttons-group-label">Fax</FormLabel>
                <TextField className="default-input" variant="outlined" {...register("investment_fax", formState, dispatch)} />
              </FormControl>
            </Grid>
            <Grid item md={4} xs={12}>
              <FormControl className="flex-c" style={{ marginTop: 25 }}>
                <FormLabel id="demo-radio-buttons-group-label">P.O. Box</FormLabel>
                <TextField className="default-input" variant="outlined" {...register("investment_po_box", formState, dispatch)} />
              </FormControl>
            </Grid>
          </Grid>
           <Grid
          ...
          >
            <Grid item md={6} xs={12}>
              <FormControl className="flex-c" style={{ marginTop: 25 }}>
                ...
                <TextField className="default-input" variant="outlined" {...register("investment_email", formState, dispatch)} />
              </FormControl>
            </Grid>
          </Grid>
        </div>
