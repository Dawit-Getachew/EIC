...
import WorkPermitReplacementTable from './WorkPermitReplacementTable';
import { subDays } from 'date-fns';
import { FC } from "react";

interface Props {
  work_permit_replacements: any[]
}

const RecentOrders: FC<Props>= ({ work_permit_replacements }) => {
  ...
  return (
    <Card>
      <WorkPermitReplacementTable cryptoOrders={work_permit_replacements.map(item => ({
        ...cryptoOrders[0],
        ...item
      })) } />
    </Card>
