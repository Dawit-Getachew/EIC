...
const GetSmallUnderlineText: FC<{ value: string; style?: object }> = (
  props
) => (
  <View style={{ display: "flex", alignItems: "center", marginLeft: 20 }}>
    <Text
      style={{ ...styles.text, ...styles.text_amh, textOverflow: "ellipsis" }}
    >
      {Boolean(props.value) && String(props.value) !== "undefined"
        ? String(props.value).length > 18
          ? `${String(props.value).slice(0, 18)}...`
          : String(props.value)
        : "-"}
    </Text>
    <View
      style={{
        ...
        height: 1,
        width:
          Boolean(props.value) && String(props.value) !== "undefined" ? 70 : 40,
        marginTop: 5,
        ...(() => {
    ...
    <Page size="A4" style={{ ...styles.flex_c, padding: 15 }} fixed>
      <View style={{ ...styles.flex_c, ...styles.flex_both_center }}>
        <Text style={{ ...styles.text_h1, ...styles.text_amh }}>
          የውጪ ሀገር ባለሀብት የኢንቨስትመንት ፍቃድ
        </Text>
        <Text style={styles.text_title}>
          INVESTMENT PERMIT FOR FORIGN INVESTOR
        </Text>
      </View>
      <View
        style={{
          ...styles.flex_c,
          ...styles.flex_JBET_AEND,
          width: "100%",
          marginTop: 10,
        }}
      >
      ...
      >
        ...
        >
            ...
            <View style={{ ...styles.flex_c, width: "90%" }}>
              <View style={{ ...styles.flex_r, width: "100%" }}>
                <View style={styles.formMiniItem}>
                  ...
                  <GetSmallUnderlineText
                    value={data.company_region_amharic}
                    style={{ marginRight: 5 }}
                  />
                </View>
                <View style={styles.formMiniItem}>
              ...
              <View style={{ ...styles.flex_r, width: "100%" }}>
                <View style={styles.formMiniItem}>
                  ...
                  <GetSmallUnderlineText
                    value={data.company_city_amharic}
                    style={{ marginRight: 5 }}
                  />
                </View>
                <View style={styles.formMiniItem}>
                  ...
                  <GetSmallUnderlineText
                    value={data.company_sub_city_amharic}
                  />
                </View>
              </View>
              <View style={{ ...styles.flex_r, width: "100%" }}>
                <View style={styles.formMiniItem}>
                  ...
                  <GetSmallUnderlineText
                    value={data.company_wereda_amharic}
                    style={{ marginRight: 5 }}
                  />
                </View>
                <View style={styles.formMiniItem}>
              ...
              <View style={{ ...styles.flex_r, width: "100%" }}>
                ...
                <View style={styles.formMiniItem}>
                  ...
                  <GetSmallUnderlineText
                    value={data.company_telephone_mobile}
                  />
                </View>
              </View>
              <View style={{ ...styles.flex_r, width: "100%" }}>
            ...
            <View style={{ ...styles.flex_c, width: "90%" }}>
              <View style={{ ...styles.flex_r, width: "100%" }}>
                <View style={styles.formMiniItem}>
                  ...
                  <GetSmallUnderlineText
                    value={data.investment_region_amharic}
                    style={{ marginRight: 5 }}
                  />
                </View>
                <View style={styles.formMiniItem}>
              ...
              <View style={{ ...styles.flex_r, width: "100%" }}>
                <View style={styles.formMiniItem}>
                  ...
                  <GetSmallUnderlineText
                    value={data.investment_city_amharic}
                    style={{ marginRight: 5 }}
                  />
                </View>
                <View style={styles.formMiniItem}>
                  ...
                  <GetSmallUnderlineText
                    value={data.investment_sub_city_amharic}
                  />
                </View>
              </View>
              <View style={{ ...styles.flex_r, width: "100%" }}>
                <View style={styles.formMiniItem}>
                  ...
                  <GetSmallUnderlineText
                    value={data.investment_wereda_amharic}
                    style={{ marginRight: 5 }}
                  />
                </View>
                <View style={styles.formMiniItem}>
              ...
              <View style={{ ...styles.flex_r, width: "100%" }}>
                ...
                <View style={styles.formMiniItem}>
                  ...
                  <GetSmallUnderlineText
                    value={data.investment_telephone_direct}
                  />
                </View>
              </View>
              <View style={{ ...styles.flex_r, width: "100%" }}>
          ...
          >
            <Text style={{ ...styles.text, ...styles.text_amh }}>
              10. የታቀደው ኤክስፖርት በመቶኛ
            </Text>
            <GetUnderlineText value={data.market_destination_amount} />
          </View>
          <Text style={{ ...styles.text, ...styles.text_amh }}>
            በኢንቨስትመንት አዋጅ ቁጥር 1180/2012 መሰረት {getCurrentDate()}{" "}
          </Text>
          <Text style={{ ...styles.text, ...styles.text_amh }}>
            አዲስ አበባ ተሰጠ
          </Text>
        ...
        >
          ...
          <View style={styles.formItem}>
            <Text style={styles.text}>
              8. Amount of Investment Capital in ETB
            </Text>
            <GetUnderlineText value={data.investment_capital_birr} />
          </View>
          <View style={styles.formItem}>
            <Text style={styles.text}>
              9. Amount of Investment Capital in USD
            </Text>
            <GetUnderlineText value={data.investment_capital_usd} />
          </View>
          <View
          ...
          <Text style={styles.text}>
            This Permit is Issued as per the Investment Proclamation In Addis
            Ababa This Day {getCurrentDate()}
          </Text>
          <View style={{ ...styles.formItem, marginTop: 30 }}>
            <Text style={{ ...styles.text, ...styles.text_amh, marginTop: 15 }}>
              እስከ
            </Text>
          ...
          <View style={{ ...styles.formItem, marginTop: 10 }}>
            ...
            <GetLongUnderlineText value={`${getCalenderDate(new Date())}`} />
          </View>
        </View>
      </View>
      <View style={{ ...styles.flex_c, marginTop: 20 }}>
        ...
        <Text style={{ ...styles.text, ...styles.text_amh }}>
          1. ይህ የኢንቨስትመንት ፈቃድ ባለሀብት የምርት ውጤቱን ወይም አገልግሎቱን ለገበያ ማቅረብ እስከሚጀምርበት ጊዜ
          ድረስ በዓመት መታደስ አለበት::
        </Text>
        <Text style={{ ...styles.text, marginBottom: 20 }}>
          The permit shall be renewed annually until the investor commences the
        ...
        <Text style={styles.text}>
          The Investor is required to obtain trade registration and license of
          the enterprise prior to be the commencement of operation.
        </Text>
      </View>
    </Page>
  </Document>
