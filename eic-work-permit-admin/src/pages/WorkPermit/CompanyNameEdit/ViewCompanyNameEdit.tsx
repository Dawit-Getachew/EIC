...
const EditCompanyName: React.FC<any> = () => {
  ...
  const _register = (name: string) => register(name, formState, dispatch, true);
  ...
  return (
    <>
      ...
      <PageTitleWrapper>
        <PageHeader
          name={selectedBuffer.company_name}
          handleSubmit={() => formSubmit(dispatch)}
          isLoading={isLoading}
        />
      </PageTitleWrapper>
      <Container maxWidth="lg" style={{ marginBottom: "20px" }}>
        ...
        >
          <Grid item xs={12}>
            <form>
              <Card sx={{ p: 4 }}>
                <CompanyNameEdit register={_register} />
              </Card>
            </form>
          </Grid>
        </Grid>
