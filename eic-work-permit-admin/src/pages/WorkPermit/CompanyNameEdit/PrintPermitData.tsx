...
const FormSmallInput: FC<{ title: string; value: string; style?: any }> = (
  props
) => (
  <View
    style={{
...
const ProductsFormTable: FC<{
  items: {
    name: string;
    unit: string;
    quantity: string;
    local_market_share: string;
    export_market_share: string;
  }[];
}> = (props) => (
  <View style={styles.tableContainer}>
    <View style={styles.flex_r}>
    ...
    <View style={styles.flex_r}>
      ...
      >
        <Text style={styles.text_normal}>
          {props.items[props.items.length - 1].unit}
        </Text>
      </View>
      <View
        style={{
      ...
      >
        <Text style={styles.text_normal}>
          {props.items[props.items.length - 1].quantity}
        </Text>
      </View>
      <View
        style={{
      ...
      >
        <Text style={styles.text_normal}>
          {props.items[props.items.length - 1].local_market_share}
        </Text>
      </View>
      <View
        style={{ ...styles.tableItem, ...styles.tableFooter, ...styles.flex_c }}
      >
        <Text style={styles.text_normal}>
          {props.items[props.items.length - 1].export_market_share}
        </Text>
      </View>
    </View>
  </View>
...
const RawMaterialsFormTable: FC<{
  items: {
    name: string;
    unit: string;
    quantity: string;
  ...
  <View style={styles.tableContainer}>
    ...
    <View style={styles.flex_r}>
      ...
      >
        <Text style={styles.text_normal}>
          {props.items[props.items.length - 1].local_source}
        </Text>
      </View>
      <View
        style={{ ...styles.tableItem, ...styles.tableFooter, ...styles.flex_c }}
      >
        <Text style={styles.text_normal}>
          {props.items[props.items.length - 1].imported_source}
        </Text>
      </View>
    </View>
  </View>
...
export const HeaderItem: FC<{ style: any }> = (props) => (
  <View
    style={{ ...styles.flex_r, justifyContent: "space-around", ...props.style }}
  >
    <View style={{ ...styles.flex_r, alignItems: "center" }}>
    ...
    <View style={{ ...styles.flex_c, alignItems: "center" }}>
      ...
      <Text style={{ ...styles.h2, ...styles.text_amh }}>
        የኢትዮጵያ ኢንቨስትመንት ኮሚሽን
      </Text>
      <Text style={{ ...styles.h3, ...styles.text_underline }}>
  ...
  return (
    <Document>
      <Page size="A4" style={{ ...styles.flex_c, padding: 15 }} fixed>
        ...
        <Text
          style={{ ...styles.text_normal, marginTop: 15, marginBottom: 15 }}
        >
          Note: This form is designed to register new investments in Ethiopia.
          Before youstart filling this form, please ensure that you have all
          information and documents necessary for this process. Please fill in
          all requierd information to make the registration process as quick and
        ...
        <View style={styles.flex_r}>
          <View style={styles.flex_c}>
            <FormCheckBox
              ...
              checked={
                props.data.type_of_business === "Private Limited Company"
              }
            />
            <FormCheckBox
              title="One Man Person Private Limited Company"
              checked={
                props.data.type_of_business ===
                "One Man Person Private Limited Company"
              }
            />
            <FormCheckBox
              title="Share Company"
              checked={props.data.type_of_business === "Share Company"}
            />
            <FormCheckBox
              title="Public Enterprise"
              checked={props.data.type_of_business === "Public Enterprise"}
            />
          </View>
          <View style={styles.flex_c}>
            <FormCheckBox
              title="Cooperative Society"
              checked={props.data.type_of_business === "Cooperative Society"}
            />
            <FormCheckBox
              title="Sole Proprietorship"
              checked={props.data.type_of_business === "Sole Proprietorship"}
            />
            <FormCheckBox
              title="Civil Society Organization"
              checked={
                props.data.type_of_business === "Civil Society Organization"
              }
            />
            <FormCheckBox
              title="Other Engaging Business"
              checked={
                props.data.type_of_business === "Other Engaging Business"
              }
            />
          </View>
        </View>
        ...
        <FormInputNew
          index={4}
          title="Name of the General Manager"
        ...
        <View style={{ ...styles.flex_r, alignItems: "center", marginTop: 20 }}>
          ...
          <Text style={{ ...styles.text_normal, ...styles.text_amh }}>
            Address of the Business Organization (የንግድ ድርጅቱ አድራሻ)
          </Text>
        </View>
        <View style={styles.flex_r}>
          <View style={styles.flex_c}>
            ...
            <FormSmallInput
              title="Sub-City"
              value={props.data.company_sub_city}
            />
            <FormSmallInput
              title="Woreda/Kebele"
              value={props.data.company_wereda}
            />
          </View>
          <View style={styles.flex_c}>
            <FormSmallInput
              title="ክልል"
              value={props.data.company_region_amharic}
            />
            <FormSmallInput
              title="ዞን"
              value={props.data.company_zone_amharic}
            />
            <FormSmallInput
              title="ከተማ"
              value={props.data.company_city_amharic}
            />
            <FormSmallInput
              title="ክፍለ ከተማ"
              value={props.data.company_sub_city_amharic}
            />
            <FormSmallInput
              title="ወረዳ/ቀበሌ"
              value={props.data.company_wereda_amharic}
            />
          </View>
        </View>
        ...
        <FormInput
          title="Telephone"
          value={props.data.company_telephone_mobile}
        />
        ...
        <View style={{ ...styles.flex_r, alignItems: "center" }}>
          ...
          <Text style={{ ...styles.text_normal, ...styles.text_amh }}>
            Home address including telephone and e-mail (የቤት አድራሻ ስልክ እና ኢሜይል)
          </Text>
        </View>
        <View style={styles.flex_c}>
          <FormInput
            title="Telephone"
            value={props.data.home_telephone_direct}
          />
        ...
        <View style={{ ...styles.flex_r, alignItems: "center" }}>
          ...
          <Text style={{ ...styles.text_normal, ...styles.text_amh }}>
            Address of authorized representative (የሕጋዊ ተወካይ አድራሻ)
          </Text>
        </View>
        <FormSmallInput
          title="Name"
          value={props.data.representative_full_name}
        />
        <FormSmallInput
          title="Phone Number"
          value={props.data.representative_telephone_direct}
        />
        ...
        >
          <FormCheckBox
            title="Agriculture"
            checked={props.data.sector === "Agriculture"}
          />
          <FormCheckBox
            title="Industry"
            checked={props.data.sector === "Industry"}
          />
          <FormCheckBox
            title="Service"
            checked={props.data.sector === "Service"}
          />
        </View>
        <FormTextArea
          index={9}
        ...
        <FormTextArea
          index={10}
          title="Brief description of the project objectivies and major activities"
          value={props.data.project_description}
        />
        <View style={{ ...styles.flex_r, marginTop: 10, alignItems: "center" }}>
          <View style={{ ...styles.number_container, marginRight: 5 }}>
          ...
          <Text style={{ ...styles.text_normal, ...styles.text_amh }}>
            Investment Location (የኢንቨስትመንት አድራሻ)
          </Text>
        </View>
        <View style={styles.flex_r}>
          <View style={styles.flex_c}>
            <FormSmallInput
              title="Region"
              value={props.data.investment_region}
            />
            <FormSmallInput title="Zone" value={props.data.investment_zone} />
            <FormSmallInput title="City" value={props.data.investment_city} />
            <FormSmallInput
              title="Sub-City"
              value={props.data.investment_sub_city}
            />
            <FormSmallInput
              title="Woreda/Kebele"
              value={props.data.investment_woreda}
            />
          </View>
          <View style={styles.flex_c}>
            <FormSmallInput
              title="ክልል"
              value={props.data.investment_region_amharic}
            />
            <FormSmallInput
              title="ዞን"
              value={props.data.investment_zone_amharic}
            />
            <FormSmallInput
              title="ከተማ"
              value={props.data.investment_city_amharic}
            />
            <FormSmallInput
              title="ክፍለ ከተማ"
              value={props.data.investment_sub_city_amharic}
            />
            <FormSmallInput
              title="ወረዳ/ቀበሌ"
              value={props.data.investment_woreda_amharic}
            />
          </View>
        </View>
        <FormInputNew
          index={12}
          title="Land Requirement (in square-meter) by type of project"
          value={props.data.land_size_sqm}
          style={{ marginTop: 0 }}
        />
        <View style={{ ...styles.flex_c, marginTop: 10 }}>
          ...
          <View style={{ ...styles.box_input, marginLeft: 30 }}>
            <Text style={{ ...styles.text_normal, ...styles.text_amh }}>
              USD {props.data.investment_capital_usd}
            </Text>
          </View>
          <View style={{ ...styles.box_input, marginLeft: 30 }}>
            <Text style={{ ...styles.text_normal, ...styles.text_amh }}>
              ETB {props.data.investment_capital_birr}
            </Text>
          </View>
        </View>
        <View style={{ ...styles.flex_c, marginTop: 10 }}>
          ...
          <View
            style={{ ...styles.flex_r, alignItems: "center", marginLeft: 30 }}
          >
            <Text
              style={{
                ...styles.text_normal,
        ...
        <FormInputNew
          ...
          value={props.data.number_of_employees}
        />
        <View style={{ ...styles.flex_c, marginTop: 10 }}>
          <View style={{ ...styles.flex_r, alignItems: "center" }}>
            <View style={{ ...styles.number_container, marginRight: 5 }}>
          ...
          >
            <FormCheckBox title="Export" checked={true} />
            <View style={{ ...styles.box_input, width: 150 }}>
              <Text style={{ ...styles.text_normal, ...styles.text_amh }}>
                {props.data.market_destination_type === "Export"
                  ? props.data.market_destination_amount
                  : 100 - Number(props.data.market_destination_amount)}
              </Text>
            </View>
          </View>
          <View
          ...
          >
            <FormCheckBox title="Local" checked={true} />
            <View style={{ ...styles.box_input, width: 150 }}>
              <Text style={{ ...styles.text_normal, ...styles.text_amh }}>
                {props.data.market_destination_type === "Local"
                  ? props.data.market_destination_amount
                  : 100 - Number(props.data.market_destination_amount)}
              </Text>
            </View>
        ...
        <View style={{ ...styles.flex_r, alignItems: "center", marginTop: 20 }}>
          ...
          <Text style={styles.text_normal}>
            Estimated annual production/service rendering of the project at full
            capacity
          </Text>
        </View>
        <ProductsFormTable
          items={props.data.products.map((item) => ({
        ...
        <View style={{ ...styles.flex_r, alignItems: "center", marginTop: 20 }}>
          ...
          <Text style={styles.text_normal}>
            Raw material requirements at full capacity (applicable to
            manufacturing and agricultural projects only)
          </Text>
        </View>
        <RawMaterialsFormTable
          items={props.data.raw_materials.map((item) => ({
            quantity: item.quantity,
            unit: item.unit,
            name: item.name,
        ...
        <FormTextArea
          index={19}
          title="Brief description about the potential impact of the proposed investment on environment and measures of mitigation to be undertaken"
          value={props.data.enviromental_impact}
        />
        <View style={{ ...styles.flex_r, marginTop: 10, alignItems: "center" }}>
          <View style={{ ...styles.number_container, marginRight: 5 }}>
          ...
          <Text style={styles.text_normal}>
            Please indicate where you received information about investing in
            Ethiopia
          </Text>
        </View>
        <View style={styles.flex_r}>
          <View style={styles.flex_c}>
            <FormCheckBox
              title="Website"
              checked={props.data.heard_from === "Website"}
            />
            <FormCheckBox
              title="Word of mouth"
              checked={props.data.heard_from === "Word of mouth"}
            />
            <FormCheckBox
              title="Friend, Family"
              checked={props.data.heard_from === "Friend, Family"}
            />
          </View>
          <View style={styles.flex_c}>
            <FormCheckBox
              title="Network"
              checked={props.data.heard_from === "Network"}
            />
            <FormCheckBox
              title="Other Government Institution"
              checked={props.data.heard_from === "Other Government Institution"}
            />
            <FormCheckBox
              title="Other"
              checked={props.data.heard_from === "Other"}
            />
          </View>
        </View>
        <View style={{ ...styles.flex_r, marginTop: 10, alignItems: "center" }}>
        ...
        <View style={styles.flex_r}>
          <View style={styles.flex_c}>
            <FormCheckBox
              ...
              checked={props.data.permit_documents.power_of_attorney.length}
            />
            <FormCheckBox
              title="Investment Visa for Foreigners"
              checked={
                props.data.permit_documents.investment_visa_for_foreigners
                  .length
              }
            />
            <FormCheckBox
              title="Notarized Minutes of Resolution"
              checked={
                props.data.permit_documents.notarized_minutes_of_resolution
                  .length
              }
            />
            <FormCheckBox
              title="Passport"
              checked={props.data.permit_documents.passport.length}
            />
          </View>
          <View style={styles.flex_c}>
            <FormCheckBox
              ...
              checked={
                props.data.permit_documents.certificate_of_incorporation.length
              }
            />
            <FormCheckBox
              title="Memorandum and Articles of Association"
              checked={
                props.data.permit_documents
                  .memorandum_and_articles_of_association.length
              }
            />
            <FormCheckBox
              title="Business Background"
              checked={props.data.permit_documents.business_background.length}
            />
          </View>
        </View>
      </Page>
