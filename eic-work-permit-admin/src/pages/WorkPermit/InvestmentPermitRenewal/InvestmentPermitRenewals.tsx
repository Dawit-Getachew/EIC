...
import InvestmentPermitsTable from './InvestmentPermitsRenewalTable';
import { subDays } from 'date-fns';
import { FC } from "react";

interface Props {
  investment_permit_renewals: any[]
}

const RecentOrders: FC<Props>= ({ investment_permit_renewals }) => {
  ...
  return (
    <Card>
      <InvestmentPermitsTable cryptoOrders={investment_permit_renewals.map(item => ({
        ...cryptoOrders[0],
        ...item
      })) } />
    </Card>
