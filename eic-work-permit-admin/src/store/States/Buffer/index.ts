export const constants = {
  ...
  "UPDATE_REPLACEMENT_FORM": "UPDATE_REPLACEMENT_FORM",
  "CLEAR_REPLACEMENT_FORM": "CLEAR_REPLACEMENT_FORM",
...
export const initialState = {
  ...
  view_investment_permit_replacement: {},
...
export const reducer = (state: any = initialState, action: any) => {
  switch(action.type) {
    ...
    case constants.UPDATE_REPLACEMENT_FORM: {
      return {
        ...state, view_investment_permit_replacement: {
          ...state.view_investment_permit_replacement,
          ...action.payload
        }
      }
    ...
    case constants.CLEAR_REPLACEMENT_FORM: {
      return {
        ...state, view_investment_permit_replacement: {}
      }
    }
...
export const Selectors = {
  ...
  selectReplacementPermitBuffer: (state: any) => state.entities[stateName].view_investment_permit_replacement,
...
export const Actions = {
  ...
  SetReplacementPermitBuffer: (payload: any) => ({ type: constants.UPDATE_REPLACEMENT_FORM, payload }),
  ClearReplacementPermitBuffer: () => ({ type: constants.CLEAR_REPLACEMENT_FORM }),
