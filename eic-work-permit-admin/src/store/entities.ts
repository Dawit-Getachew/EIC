...
import { reducer as WorkPermitReducer, stateName as work_permit } from './States/WorkPermit/WorkPermitApplications'
import { reducer as RenewWorkPermitReducer, stateName as renew_work_permit } from './States/Investment/RenewWorkPermit/'
import { reducer as AdminReducer, stateName as admin } from './States/Admin/'
import { reducer as ReplaceWorkPermitReducer, stateName as replace_work_permit } from './States/WorkPermit/ReplaceWorkPermit/'
import { reducer as CancelWorkPermitReducer, stateName as cancel_work_permit } from './States/WorkPermit/CancelWorkPermit/'
...
export default combineReducers({
  ...
  [renew_work_permit]: RenewWorkPermitReducer,
  [admin]: AdminReducer,
  [replace_work_permit]: ReplaceWorkPermitReducer,
  [cancel_work_permit]: CancelWorkPermitReducer
})