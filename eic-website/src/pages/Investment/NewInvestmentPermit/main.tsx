      ...
      <div className="flex-c">
        <div className="flex-r">
          <div className="new-permit-container">
            ...
            {(activeStep === 1) && <BasicAddress pageClickCount={pageClickCount} nextPage={nextPage} />}
            ...
            {(activeStep === 4) && <DocumentAttach pageClickCount={pageClickCount} nextPage={submitApplication} />}
            {(activeStep === 5) && <Confirmation />}
            {(activeStep !== 5) &&  <div className="footer-buttons">
              <div>
                <Button
                  style={{
                    color: '#707070',
