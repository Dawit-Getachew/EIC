      ...
      <div className="form-box-content">
        ...
        >
          <Grid item md={6} xs={12}>
            <FormControl className="flex-c">
              ...
              <PhoneInput registerPhone={() => register("business_telephone", formState, dispatch)} />
            </FormControl>
          </Grid>
          <Grid item md={6} xs={12}>
            <FormControl className="flex-c">
        ...
        >
          <Grid item md={6} xs={12}>
            <FormControl className="flex-c">
              <FormLabel id="demo-radio-buttons-group-label">Telephone Number</FormLabel>
              <PhoneInput registerPhone={() => register("home_telephone", formState, dispatch)} />
            </FormControl>
          </Grid>
          <Grid item md={6} xs={12}>
            <FormControl className="flex-c">
        ...
        >
          <Grid item md={6} xs={12}>
            <FormControl className="flex-c">
              ...
              <PhoneInput registerPhone={() => register("representative_tel_1", formState, dispatch)} />
            </FormControl>
          </Grid>
          <Grid item md={6} xs={12}>
            <FormControl className="flex-c">
              <FormLabel id="demo-radio-buttons-group-label">Telephone Number #2</FormLabel>
              <PhoneInput registerPhone={() => register("representative_tel_2", formState, dispatch)} />
            </FormControl>
          </Grid>
        </Grid>
        <Grid
