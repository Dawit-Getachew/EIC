...
const steps = [
  ...
  {
    title: "2. Address",
    description: "Fill in the address relating to company and represenatative",
    icon: UserLocationIcon,
  },
  {
    title: "3. Investment Detail",
    description: "Fill in the detail of the investment project",
    icon: UserInvestIcon,
  },
  {
    title: "4. Document Attach",
          ...
          <div className="info-submit-container">
            ...
            <Button
              ...
              onClick={() => {
                props.closePage();
                navigate(
                  routes.INVESTMENT.NEW_INVESTMENT_PERMIT_PROPRIETORSHIP.ROUTE,
                  {
                    replace: true,
                  }
                );
