  ...
  const submitApplication = async (formData: any) => {
    ...
    InvestmentPermitExpansionAPI.CreateInvestmentPermitExpansion({
      ...
      anticipated_products: data.anticipated_products.map(item => ({
        ...
        unit: String(item.unit),
        percentage_capacity_increased: Number(item.percentage_capacity_increased),
      ...
      project_impl_plan: {
        ...
        reaching_of_machinery_at_project_site: data.reaching_machinery_at_project_site,
        ...
        co_missing_machines_and_make_ready_for_operator: data.co_missing_machines_make_ready_for_operator,
      ...
      <div className="flex-c">
        <div className="flex-r">
          <div className="new-permit-container">
            ...
            {(activeStep === 5) && <DocumentAttach pageClickCount={pageClickCount} nextPage={submitApplication} />}
