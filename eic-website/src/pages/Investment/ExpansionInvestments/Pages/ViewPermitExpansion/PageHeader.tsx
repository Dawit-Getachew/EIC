      ...
      <Box display="flex" mb={3}>
        <Tooltip arrow placement="top" title="Go back">
          <IconButton color="primary" sx={{ p: 2, mr: 2 }} onClick={() => {
            navigate(routes.INVESTMENT.EXPANSION_INVESTMENT_PERMIT_LIST.ROUTE, { replace: true })
          }}>
          ...
          <Grid item md={9}>
            <Box>
              ...
              <Typography variant="subtitle2">
                This is a page shows every detail of {props.data.company_name} investment application
              </Typography>
            </Box>
          </Grid>
            ...
            <Tooltip arrow placement="top" title="Print Expansion Permit Form">
              ...
              >
                {props.data.permit_status === "APPROVED" ? <PDFDownloadLink
                  document={<ExpansionPermitDocument data={{
                    ...props.data,
                    ...(() => {
