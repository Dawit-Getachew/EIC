...
const texts = [
  {
    ...
    description: "This form is designed to expand already existing investments in Ethiopia."
  },
  {
    title: "How to submit your request?",
    description: "This site allows you to submit the application online. It's a simple, five-step process that only takes a few minutes."
  },
  {
    title: "How do I prepare to submit my investment expansion application form?",
