...
const menuItems: MenuItems[] = [
  ...
  },
  {
    ...
    items: [
      ...
      // },
      {
        name: "Investment Permits",
        icon: StickyNote2,
        link: routes.INVESTMENT.INVESTMENT_PERMIT.ROUTE,
      },
      // {
      ...
      // },
      {
        name: "Renew Investment Permit",
        icon: RestorePage,
        link: routes.INVESTMENT.INVESTMENT_PERMIT_RENEWAL.ROUTE,
      },
      // {
      //   name: "Managers",
      ...
      // },
      {
        name: "Expansion",
        icon: AllOutIcon,
        link: routes.INVESTMENT.PROJECT_EXPANSION.ROUTE,
      },
      {
        name: "Amendments",
        icon: SettingsIcon,
      ...
      },
      {
        name: "Cancellation",
        icon: CloseIcon,
        link: routes.INVESTMENT.INVESTMENT_PERMIT_CANCELLATION.ROUTE,
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        link: routes.INVESTMENT.MANAGE_ACCOUNT.ROUTE,
      },
      {
        name: "Assign Work",
        icon: FilterVintageTwoToneIcon,
        link: routes.DIRECTOR_PAGES.ASSIGN_INVESTMENT_PERMIT.ROUTE,
      },
    ],
  },
  //   heading: "Dashboards",
