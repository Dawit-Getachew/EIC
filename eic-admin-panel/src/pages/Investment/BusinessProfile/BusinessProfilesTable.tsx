...
const RecentOrdersTable: FC<RecentOrdersTableProps> = ({ cryptoOrders }) => {
  const [selectedBusinessProfiles, setSelectedCryptoOrders] = useState<string[]>(
    []
  );
  ...
  const [selectedBusinessProfile, setSelectedBusinessProfile] = useState({ address: {} })
                ...
                >
                  ...
                  <TableCell>
                    <Typography
                      ...
                      noWrap
                    >
                      {String(businessProfile.form_of_ownership).replace("_", " ")}
                    </Typography>
                  </TableCell>
                  <TableCell>
                    <Typography
                  ...
                  <TableCell align="right">
                    ...
                    <Tooltip title="Edit Profile" arrow>
                      <IconButton
                        ...
                        size="small"
                        onClick={() => {
                          dispatch(BusinessProfileActions.SelectBusinessProfile(businessProfile))
                          navigate(routes.INVESTMENT.EDIT_BUSINESS_PROFILE.ROUTE, { replace: true })
                        }}
                      >
