                ...
                >
                  ...
                  <TableCell>
                    <Typography
                      ...
                      noWrap
                    >
                      {`${getManager(workPermit.selected_manager, managers).first_name}
                       ${getManager(workPermit.selected_manager, managers).middle_name}
                       ${getManager(workPermit.selected_manager, managers).last_name}`
                      }
                    </Typography>
                  </TableCell>
                  ...
                  <TableCell align="right">
                    ...
                    <Tooltip title="Edit Work Permit" arrow>
                      <IconButton
                        sx={{
                          '&:hover': {
                            background: theme.colors.primary.lighter
                        ...
                        size="small"
                        onClick={() => {
                          dispatch(WorkPermitActions.SelectWorkPermit(workPermit))
                          navigate(routes.INVESTMENT.EDIT_WORK_PERMIT.ROUTE, { replace: true })
                        }}
                      >
                        <EditTwoToneIcon fontSize="small" />
                      </IconButton>
                    </Tooltip>
                    <Tooltip title="Delete Work Permit" arrow>
                      <IconButton
                        sx={{
