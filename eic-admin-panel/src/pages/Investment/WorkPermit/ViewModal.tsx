...
import { LegalStatusTypes, FormOfOwnerShipTypes, IBusinessProfileInput } from "src/models/InvestmentModels/business_profile"
...
const ViewModal: React.FC<ViewModalProps> = ({ isVisible, onClose, business_profile }) => {
  return (
    <div>
      <Modal
        open={isVisible}
