...
const RecentOrdersTable: FC<RecentOrdersTableProps> = ({ cryptoOrders }) => {
  ...
  const UpdatePermit: FC<{ investmentPermit: any }> = ({ investmentPermit }) => {
    ...
    return (
      <Tooltip title="Cancel Permit" arrow>
        <IconButton
          sx={{
            "&:hover": {
          ...
          disabled={
            (investmentPermit.permit_status === getCancelPermitStatus(user_role)) || isLoading
          }
        >
          {isLoading ? <CircularProgress /> : <DoDisturbIcon fontSize="small" />}
        </IconButton>
      </Tooltip>
    )
  }
                ...
                >
                  ...
                  <TableCell align="right">
                    <div style={{ display: "flex", flexDirection: "row", justifyContent: "space-between" }}>
                      <Tooltip title="View Cancellation Request" arrow>
                        <IconButton
                          sx={{
                            '&:hover': {
                              background: theme.colors.primary.lighter
                          ...
                          size="small"
                          onClick={() => {
                            dispatch(BufferActions.SetCancellationPermitBuffer(investmentPermit))
                            navigate(routes.INVESTMENT.VIEW_INVESTMENT_PERMIT_CANCELLATION.ROUTE, { replace: true })
                          }}
                        >
                      ...
                      <Tooltip title="View Permit" arrow>
                        <IconButton
                          ...
                          onClick={() => {
                            ...
                            navigate(
                              routes.INVESTMENT
                                .INVESTMENT_PERMIT_CANCELLATION_VIEW.ROUTE +
