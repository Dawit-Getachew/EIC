    ...
    <Document>
      <Page size="A4" style={{ ...styles.flex_c, padding: 15 }} fixed>
        ...
        <View style={{ ...styles.flex_c, marginTop: 10 }}>
          ...
          <View style={{ ...styles.flex_r, alignItems: "center", justifyContent: "space-between", width: 250 }}>
            <FormCheckBox title="Export" checked={true} />
            <View style={{ ...styles.box_input, width: 150 }}>
              <Text style={{ ...styles.text_normal, ...styles.text_amh }}>{props.data.market_destination_type === "Export" ? props.data.market_destination_amount : 100 - Number(props.data.market_destination_amount)}</Text>
            </View>
          </View>
          <View style={{ ...styles.flex_r, alignItems: "center", justifyContent: "space-between", width: 250 }}>
            <FormCheckBox title="Local" checked={true} />
            <View style={{ ...styles.box_input, width: 150 }}>
              <Text style={{ ...styles.text_normal, ...styles.text_amh }}>{props.data.market_destination_type === "Local" ? props.data.market_destination_amount : 100 - Number(props.data.market_destination_amount)}</Text>
            </View>
          </View>
        </View>
        <View style={{ ...styles.flex_r, alignItems: "center", marginTop: 20 }}>
