...
import InvestmentPermitsTable from './InvestmentPermitsTable';
import { subDays } from 'date-fns';
import { FC } from "react";

interface Props {
  investment_permits: any[]
}

const RecentOrders: FC<Props>= ({ investment_permits }) => {
  ...
  return (
    <Card>
      <InvestmentPermitsTable cryptoOrders={investment_permits.map(item => ({
        ...cryptoOrders[0],
        ...item
      })) } />
    </Card>
