...
const InvestmentDetail: FC<Props> = (props) => {
  ...
  const optional_inputs = ["investment_activity_amharic", "investment_address"];
    ...
    if (Object.keys(savedBuffer.employee_information).length > 0) {
      FormActions.UpdateFormData(
        selectRequriedKeys(
          ...
          savedBuffer.employee_information
        ),
        dispatch
      );
    }
  ...
  return (
    <>
      <div>
        <div>
            ...
            <Grid item md={6} xs={12}>
              <FormControl className="flex-c" style={{ marginTop: 25 }}>
                ...
                {getFormError(formState, "sector").error ? (
                  <p style={{ color: "red" }}>
                    {getFormError(formState, "sector").helperText}
                  </p>
                ) : (
                  <></>
                )}
          ...
          >
            <Grid item md={6} xs={12}>
              ...
              >
                ...
                {getFormError(formState, "investment_activity").error ? (
                  <p style={{ color: "red" }}>
                    {getFormError(formState, "investment_activity").helperText}
                  </p>
                ) : (
                  <></>
                )}
            ...
            <Grid item md={6} xs={12}>
              ...
              >
                ...
                {getFormError(formState, "investment_activity_amharic")
                  .error ? (
                  <p style={{ color: "red" }}>
                    {
                      getFormError(formState, "investment_activity_amharic")
          ...
          <Grid container width="100%" spacing={4} justifyContent="flex-start">
            <Grid item md={6} xs={12}>
              ...
              >
                <FormLabel className="invest-title">
                  Brief description of the project objectivies and major
                  activities
                </FormLabel>
                {getFormError(formState, "project_description").error ? (
                  <p style={{ color: "red" }}>
                    {getFormError(formState, "project_description").helperText}
                  </p>
                ) : (
                  <></>
                )}
          ...
          <div className="invest-title">Investment Location</div>
            ...
            <Grid item md={4} xs={12}>
              <FormControl className="flex-c" style={{ marginTop: 25 }}>
                ...
                <TextField
                  ...
                  variant="outlined"
                  {...register("investment_region", formState, dispatch)}
                />
              </FormControl>
            </Grid>
            <Grid item md={4} xs={12}>
              <FormControl className="flex-c" style={{ marginTop: 25 }}>
                ...
                <TextField
                  className="default-input"
                  variant="outlined"
                  {...register("investment_city", formState, dispatch)}
                />
              </FormControl>
            </Grid>
            <Grid item md={4} xs={12}>
              <FormControl className="flex-c" style={{ marginTop: 25 }}>
                ...
                <TextField
                  className="default-input"
                  variant="outlined"
                  {...register("investment_sub_city", formState, dispatch)}
                />
              </FormControl>
            </Grid>
          </Grid>
            ...
            <Grid item md={4} xs={12}>
              <FormControl className="flex-c" style={{ marginTop: 25 }}>
                ...
                <TextField
                  className="default-input"
                  variant="outlined"
                  {...register("investment_zone", formState, dispatch)}
                />
              </FormControl>
            </Grid>
            <Grid item md={4} xs={12}>
              <FormControl className="flex-c" style={{ marginTop: 25 }}>
                ...
                <TextField
                  className="default-input"
                  variant="outlined"
                  {...register("investment_house_number", formState, dispatch)}
                />
              </FormControl>
            </Grid>
          </Grid>
            ...
            <Grid item md={4} xs={12}>
              <FormControl className="flex-c" style={{ marginTop: 25 }}>
                ...
                <TextField
                  className="default-input"
                  variant="outlined"
                  {...register("investment_fax", formState, dispatch)}
                />
              </FormControl>
            </Grid>
            <Grid item md={4} xs={12}>
              <FormControl className="flex-c" style={{ marginTop: 25 }}>
                ...
                <TextField
                  className="default-input"
                  variant="outlined"
                  {...register("investment_po_box", formState, dispatch)}
                />
              </FormControl>
            </Grid>
          </Grid>
            ...
            <Grid item md={6} xs={12}>
              <FormControl className="flex-c" style={{ marginTop: 25 }}>
                ...
                <TextField
                  className="default-input"
                  variant="outlined"
                  {...register("investment_email", formState, dispatch)}
                />
              </FormControl>
            </Grid>
          </Grid>
            ...
            <Grid item md={6} xs={12}>
              <FormControl className="flex-c" style={{ marginTop: 25 }}>
                ...
                <TextField
                  ...
                  variant="outlined"
                  {...register("land_size_sqm", formState, dispatch)}
                  type="number"
                />
              </FormControl>
            </Grid>
        ...
        <div className="form-box-content">
          <div className="invest-title">
            Estimated number of employees at full capacity
          </div>
          <Grid container width="100%">
            <Grid item md={12}>
              <div className="invest-sub-title">Permanent Employees</div>
            </Grid>
            <Grid item md={6} xs={12}>
              <FormControl className="flex-c" style={{ marginTop: 25 }}>
                ...
                <TextField
                  className="long-input"
                  variant="outlined"
                  {...register("permanent_male_amount", formState, dispatch)}
                  type="number"
                />
              </FormControl>
            </Grid>
            <Grid item md={6} xs={12}>
              <FormControl className="flex-c" style={{ marginTop: 25 }}>
                ...
                <TextField
                  className="long-input"
                  variant="outlined"
                  {...register("permanent_female_amount", formState, dispatch)}
                  type="number"
                />
              </FormControl>
            </Grid>
          ...
          <Grid container width="100%">
            <Grid item md={12}>
              <div className="invest-sub-title">Temporary Employees</div>
            </Grid>
            <Grid item md={6} xs={12}>
              <FormControl className="flex-c" style={{ marginTop: 25 }}>
                <FormLabel id="demo-radio-buttons-group-label">Male</FormLabel>
                <TextField
                  className="long-input"
                  variant="outlined"
                  {...register("temporary_male_amount", formState, dispatch)}
                  type="number"
                />
              </FormControl>
            </Grid>
            <Grid item md={6} xs={12}>
              <FormControl className="flex-c" style={{ marginTop: 25 }}>
                ...
                <TextField
                  className="long-input"
                  variant="outlined"
                  {...register("temporary_female_amount", formState, dispatch)}
                  type="number"
                />
              </FormControl>
            </Grid>
