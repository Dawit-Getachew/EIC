...
import { API, Selectors as ManagerSelectors } from "src/store/States/Investment/Manager/"

const EditManager: React.FC<any> = () => {
  const { register, handleSubmit, watch, formState: { errors } } = useForm<IManagerInput>();
