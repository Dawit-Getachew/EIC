...
const sidebar_items = [
  ...
  },
  {
    Icon: AccountCircle,
    title: "Services",
    link: routes.WORK_PERMIT.SERVICES.ROUTE,
  },
  {
    Icon: AddIcon,
    title: "New Work Permit",
    link: routes.WORK_PERMIT.NEW_WORK_PERMIT.ROUTE,
  },
  {
    Icon: AutoAwesomeMosaicIcon,
    title: "My Work Permits",
    link: routes.WORK_PERMIT.MY_WORK_PERMITS.ROUTE,
  },
  {
    Icon: DoneAllIcon,
    title: "Renew Work Permits",
    link: routes.WORK_PERMIT.RENEW_INVESTMENT_PERMIT.ROUTE,
  },
  {
    Icon: CloseIcon,
    title: "Cancel Work Permits",
    link: routes.WORK_PERMIT.CANCEL_INVESTMENT_PERMIT.ROUTE,
  },
  {
    Icon: AccountTreeTwoToneIcon,
    title: "Expand Work Permits",
    link: routes.WORK_PERMIT.EXPAND_MY_INVESTMENT_PERMITS.ROUTE,
  },
  {
    Icon: SettingsIcon,
    title: "Amend Work Permits",
    link: routes.WORK_PERMIT.AMEND_INVESTMENT_PERMIT.ROUTE,
  },
];
        ...
        <div className="sidebar-container">
          ...
          >
            <Grid item style={{ textAlign: "center" }}>
              ...
              <Typography
                variant="h4"
                className="sidebar-logo-txt lower-logo-txt"
              >
                Work Permit
              </Typography>
            </Grid>
