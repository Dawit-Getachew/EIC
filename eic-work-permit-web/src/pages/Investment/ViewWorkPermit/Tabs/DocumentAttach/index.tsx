      ...
      <div>
        ...
        <div className="form-box-content">
          <Grid container width="100%" spacing={4}>
            <Grid item md={6} xs={12}>
              <div style={{ fontSize: 18, fontWeight: 700 }}>Document Attach</div>
            </Grid>
          </Grid>
          ...
          <Grid container width="100%" spacing={4} justifyContent="flex-start">
            <Grid item md={12} xs={12}>
              <div
                className="document-attach-h1"
                style={{ marginBottom: 10, marginTop: 20 }}
              >
                Please indicate where you recevied information about investing
                in Ethiopia?
              </div>
            </Grid>
          </Grid>
