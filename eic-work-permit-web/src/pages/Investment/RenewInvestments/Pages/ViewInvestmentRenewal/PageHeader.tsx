...
const PageHeader = () => {
  ...
  useEffect(() => {
    dispatch(BufferActions.SetBreadCrumps([
      ...
      {
        path: '/invest/renew/view',
        title: `${savedBuffer.company_name} Investment Permit Renewal Form`
      }
    ]))
  }, [dispatch])
      ...
      <Box display="flex" mb={3}>
        <Tooltip arrow placement="top" title="Go back">
          <IconButton
            ...
            sx={{ p: 2, mr: 2 }}
            onClick={() => {
              navigate(routes.WORK_PERMIT.RENEW_INVESTMENT_PERMIT.ROUTE, {
                replace: true,
              });
            }}
          >
