  ...
  useEffect(() => {
    ...
    InvestmentPermitAmmendmentAPI.FetchInvestmentPermitAmmendments(
      (err, data) => {
        if (err) throw err;
        dispatch(
          InvestmentPermitAmmendmentActions.setInvestmentPermitAmmendments(data)
        );
      }
    );
  }, [dispatch]);
                  ...
                  {Boolean(
                    ...
                    <Tooltip title={"Amend Permit"} arrow>
                      <IconButton
                        ...
                        onClick={() => {
                          dispatch(
                            BufferActions.SetAmmendmentPermitBuffer(
                              investmentPermit
                            )
                          );
                          navigate(
                            routes.WORK_PERMIT.AMEND_INVESTMENT_PERMIT_FORM
                              .ROUTE,
                            { replace: true }
                          );
                        }}
                    ...
                    <Tooltip title={"View Ammendment Request"} arrow>
                      <IconButton
                        ...
                        onClick={() => {
                          ...
                          navigate(
                            routes.WORK_PERMIT.AMEND_INVESTMENT_PERMIT_VIEW
                              .ROUTE,
                            { replace: true }
                          );
                        }}
