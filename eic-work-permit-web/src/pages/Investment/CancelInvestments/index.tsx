          ...
          <TableBody>
            {rows.map((investmentPermit, idx) => (
              <TableRow hover key={investmentPermit._id}>
                ...
                <TableCell align="right">
                  {!Boolean(
                    investmentPermit.permit_status === PermitStatus.CANCELLED ||
                      investmentPermit.permit_status ===
                    ...
                    <Tooltip title="View Cancellation Request" arrow>
                      <IconButton
                        ...
                        onClick={() => {
                          dispatch(
                            BufferActions.SetCancellationPermitBuffer(
                              investmentPermit
                            )
                          );
                          navigate(
                            routes.WORK_PERMIT.CANCEL_INVESTMENT_PERMIT_VIEW
                              .ROUTE,
                            { replace: true }
                          );
                        }}
                    ...
                    <Tooltip title={"Cancel Permit"} arrow>
                      <IconButton
                        ...
                        onClick={() => {
                          ...
                          navigate(
                            routes.WORK_PERMIT.CANCEL_INVESTMENT_PERMIT_FORM
                              .ROUTE,
                            { replace: true }
                          );
                        }}
