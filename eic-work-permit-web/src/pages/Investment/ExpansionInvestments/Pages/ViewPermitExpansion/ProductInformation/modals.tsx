 ...
 * name: "name"
      quantity: 12
      local_share_market: 34
      export_share_market: 12
      unit: "m2"
      percentage_capacity_increased: 12
      percentage_unit_increased: 12
 */

export const AnticipatedProductModalElement: React.FC<ModalProps> = (props) => {
  const inputs = [
    "name",
    "local_share_market",
    "unit",
    ...
    >
      <Box sx={style}>
        ...
        >
          ...
          <Grid item md={4} xs={12}>
            <FormControl className="flex-c" style={{ marginTop: 25 }}>
              ...
              <TextField  variant="outlined" type="number" {...register("quantity", formState, dispatch)} />
            </FormControl>
          </Grid>
        </Grid>
        <Grid
        ...
        >
          <Grid item md={4} xs={12}>
            <FormControl className="flex-c" style={{ marginTop: 25 }}>
              ...
              <TextField  variant="outlined" type="number" {...register("local_share_market", formState, dispatch)} />
            </FormControl>
          </Grid>
          <Grid item md={4} xs={12}>
            <FormControl className="flex-c" style={{ marginTop: 25 }}>
              <FormLabel id="demo-radio-buttons-group-label">Export Share Market</FormLabel>
              <TextField  variant="outlined" type="number" {...register("export_share_market", formState, dispatch)} />
            </FormControl>
          </Grid>
        </Grid>
        <Grid
        ...
        >
          <Grid item md={4} xs={12}>
            <FormControl className="flex-c" style={{ marginTop: 25 }}>
              <FormLabel id="demo-radio-buttons-group-label">Percentage Capacity Increased</FormLabel>
              <TextField  variant="outlined" type="number" {...register("percentage_capacity_increased", formState, dispatch)} />
            </FormControl>
          </Grid>
          <Grid item md={4} xs={12}>
            <FormControl className="flex-c" style={{ marginTop: 25 }}>
              <FormLabel id="demo-radio-buttons-group-label">Percentage Unit Increased</FormLabel>
              <TextField  variant="outlined" type="number" {...register("percentage_unit_increased", formState, dispatch)} />
            </FormControl>
          </Grid>
        </Grid>
        <Grid
        ...
        >
          <Grid item md={4} xs={12}>
            <FormControl className="flex-c" style={{ marginTop: 25 }}>
              ...
              <TextField  variant="outlined" type="number" {...register("local_source", formState, dispatch)} />
            </FormControl>
          </Grid>
          <Grid item md={4} xs={12}>
            <FormControl className="flex-c" style={{ marginTop: 25 }}>
              <FormLabel id="demo-radio-buttons-group-label">IMPORTED (PERCENT)</FormLabel>
              <TextField  variant="outlined" type="number" {...register("import_source", formState, dispatch)} />
            </FormControl>
          </Grid>
        </Grid>
        <Grid
