        ...
        >
          <Grid item md={6} xs={12}>
            <FormControl className="flex-c" style={{ marginTop: 25 }}>
              ...
              <TextField type="number"  variant="outlined" {...register("proposed_expansion_capital", formState, dispatch)} />
            </FormControl>
          </Grid>
        </Grid>
        <Grid
        ...
        >
          ...
          <Grid item md={4} xs={12}>
            <FormControl className="flex-c" style={{ marginTop: 25 }}>
              ...
              <TextField  variant="outlined" {...register("other_cost", formState, dispatch)} type="number" />
            </FormControl>
          </Grid>
        </Grid>
      </div>
